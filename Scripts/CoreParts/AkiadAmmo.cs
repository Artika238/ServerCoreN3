...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        {
            AmmoMagazine = "Lancer50standard", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "50mm Standard", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 2000f, // Direct damage; one steel plate is worth 100.
            Mass = 43f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 10000f, // Recoil.
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                {
                    Radius = 10f, // The sphere of influence of the area effect, in metres.
                ...
                Pulse = new PulseDef // Settings for EWAR fields.
                {
                    ...
                    Particle = new ParticleDef // Particle effect to generate at the field's position.
                    {
                        ...
                        Color = Color(red: 128, green: 0, blue: 0, alpha: 32), // Deprecated, set color in particle sbc.
