...
{ // Don't edit above this line
    ...
    {
		private AnimationDef OrionLaunch => new AnimationDef
        {
            //Emissives = new []
            //{
            ...
            WeaponAnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("Orb1"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb2"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb3"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb4"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb5"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb6"), //Subpart you will be animating
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb7"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_007", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb8"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_008", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb9"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_009", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb10"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_010", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb11"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_011", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb12"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_012", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb13"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_013", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb14"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_014", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb15"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_015", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb16"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_016", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb17"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_017", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb18"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_018", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb19"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_019", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("Orb20"), //Subpart you will be animating
                    BarrelId = "muzzle_missile_020", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
				...
				new PartAnimationSetDef()
                {
                    SubpartId = Names("OrionStock"), //Subpart you will be animating
                               ...
                               new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0, -0.30), //linear movement
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
